...
public class HQLUtil {
	 ...
	 * @return
	 */
	public static String createQueryListHQLNotIn(String entityName,String orderAttr,
			String orderType, String notAttr,String notType,Set<String>... attrNames) {
		StringBuffer hqlStr = new StringBuffer("from ").append(entityName)
				.append(" as o ");
		if (attrNames.length > 0) {
			hqlStr.append("where 1=1 ");
		...
		if(null!=notAttr){
			hqlStr.append("and o.").append(notAttr).append(" not in (").append(notType).append(") ");
		}
		if (null!=orderAttr) {
			hqlStr.append("order by o.").append(orderAttr).append(" ").append(orderType);
		}
