...
import com.modules.util.PropertiesFileReader;
...
//	public static final String SERVER_HOST="211.149.151.106";
//	public static final String SERVER_HOST="211.149.216.154";
	
	public static final String SERVLET_CONTEXT="/";

	// sign key
	public static final String SIGN_KEY = "jfeimao2016";
	
	//sha hash 加密遍历数
	public static final int HASH_ITERATIONS = 2016;
	...
	//public static String JFEIMAO_INSULATE_URL = "http://127.0.0.1/jfeimao-server-insulate"; // 隔离层
	//public static String JFEIMAO_ORDERIN_URL = "http://127.0.0.1/jfeimao-server-orderin"; // 订单子系统
	//public static String JFEIMAO_MESSAGE_URL = "http://127.0.0.1/jfeimao-server-message"; // 消息推送子系统
	//public static String JFEIMAO_WECHAT_URL = "http://127.0.0.1/jfeimao-server-wechat"; 	// 微信子系统
	//public static String JFEIMAO_MEMBER_URL = "http://127.0.0.1/jfeimao-server-member"; 	// 用户子系统
	...
	/**Email*/
	//email host
	public static String EMAIL_HOST = PropertiesFileReader.get("mail.host", CONF_PROPERTIES);
	
	//email port
	public static String EMAIL_PORT = PropertiesFileReader.get("mail.port", CONF_PROPERTIES);
	
	//email account
	public static String EMAIL_ACCOUNT = PropertiesFileReader.get("mail.account", CONF_PROPERTIES);
	
	//email password
	public static String EMAIL_PWD = PropertiesFileReader.get("mail.pwd", CONF_PROPERTIES);
	
	
	/**SMS*/
	//sms host
	public static String SMS_HOST = PropertiesFileReader.get("sms.host", CONF_PROPERTIES);
	
	//sms account
	public static String SMS_ACCOUNT = PropertiesFileReader.get("sms.account", CONF_PROPERTIES);
	
	//sms port
	public static String SMS_PWD = PropertiesFileReader.get("sms.pwd", CONF_PROPERTIES);
	
	//sms charset
	public static String SMS_CHARSET = PropertiesFileReader.get("sms.charset", CONF_PROPERTIES);
	
	//sms contentType
	public static String SMS_CONTENTTYPE = PropertiesFileReader.get("sms.contentType", CONF_PROPERTIES);
	
	/**上传*/
	//upload temp path
	public static String UPLOAD_TEMP_PATH = PropertiesFileReader.get("uploaddify.temp.path", CONF_PROPERTIES);
	
	//upload img path
	public static String UPLOAD_IMG_PATH = PropertiesFileReader.get("uploaddify.img.path", CONF_PROPERTIES);
