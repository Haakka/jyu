...
public interface BaseDao {
	...
	/**
	 * 根据entityClass及attrs属性查询指定页面记录,支持分页,支持字段not in
	 */
	@SuppressWarnings("unchecked")
	 ...
	 */
	public <T> List<T> queryList(Class<T> entityClass, String orderAttr, String orderType, @SuppressWarnings("unchecked") Map<String, Object>... attrs);
