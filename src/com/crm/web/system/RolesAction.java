...
import com.crm.entity.RolesAuthoritiesId;
...
public class RolesAction extends PageAction {
	...
	public String editAuth() throws Exception {
		Roles role = rolesManagerDao.getRoles(id);
		setRoles(role);
	...
	public String update() throws Exception {
		...
		com.crm.entity.Authorities authorities;
		if(checkedMenu != null){
	...
	public String updateRose() throws Exception {
		roles.setName(name);
		rolesManagerDao.updateRoles(roles);
		return "list";
	}
	...
	public String addRose() throws Exception {
		roles.setName(name);
		rolesManagerDao.addRoles(roles);
		return "list";
	}
