		...
		<div class="page-content">
			<div>
				<h3 class="row-fluid header smaller  blue" style="line-height: 39px;">
					<span class="span7">新增用户 </span><!-- /span -->
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form action="usersAction!add.action" method="post" id="userForm"  class="form-horizontal" role="form">
						<s:token></s:token>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" name="loginName" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-12 col-sm-1 control-label no-padding-right" for="form-field-1">密码</label>
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
						...
						<div class="form-group">
							<label class="col-xs-12 col-sm-1 control-label no-padding-right" for="form-field-1">重复密码</label>
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<select name="checkmenu">
										<c:forEach var="roles" items="${rolesList}" varStatus="status">
											<option value="${roles.id}" <c:if test="${status.first}">selected='selected'</c:if> >${roles.name}&nbsp;&nbsp;</option>
										 </c:forEach>
									</select>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="input-group">
									<input class="form-control date-picker" name="birthday" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" style="width: 210px;"/>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="input-group">
									<input class="form-control date-picker" name="entryDate" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" style="width: 210px;"/>
									<span class="input-group-addon" style="width: 40px;">
										<i class="icon-calendar bigger-110"></i>
									</span>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" name="idcardno" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" name="workphone" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<textarea name="remark" style="width: 385px;height: 100px;" placeholder="最多输入500个字符"></textarea>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" name="qq" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
						<div class="form-group">
