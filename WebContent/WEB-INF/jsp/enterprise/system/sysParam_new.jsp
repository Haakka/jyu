	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${ctx}/system/sysParamAction!findAllByTypeId.action?id=${id }">系统参数</a>
				</li>
			</ul>
		</div><!-- .breadcrumb -->
					...
					<form action="#" method="post" id="sysParamForm"  class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="sysParam.name" id="sysParam.name"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="sysParam.sort" />
								</div>
							</div>
						</div>
						<div class="form-group">
			...
			$("#sysParamForm").validate({
				...
				errorClass: 'help-block',
				 rules: { 
					'sysParam.name': { 
	        			...
	        			maxlength:250,
	        			remote:{
	    		            url: "sysParamAction!isUniqueName.action",
	    		            type: "post",
	    		            dataType: 'json',
	    			        data: {
	    			            name:  function() {   
                                   			 return $("#sysParam\\.name").val();   
                                		}  
	    			            }
	    		            }
	    			},
				...
				errorPlacement: function (error, element) {
				 ...
				 submitHandler:function(form){
					 ajaxAdd(form,'sysParamAction!newSysParam.action');
			     }
			});
		});
	</script>
