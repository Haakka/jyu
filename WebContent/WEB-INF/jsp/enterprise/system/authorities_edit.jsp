		...
		<div class="page-content">
			<div>
				<h3 class="row-fluid header smaller  blue" style="line-height: 39px;">
					<span class="span7">编辑权限 </span><!-- /span -->
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form action="authoritiesAction!update.action" method="post" id="authForm"  class="form-horizontal" role="form">
						<s:token></s:token>
						...
						<div class="form-group" <c:if test="${authorities.authoritiesType == 2}">style="display: none;"</c:if>>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" id="" name="name" value="${authorities.name}" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" id="displayName" name="displayName" value="${authorities.displayName}" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
				...
				errorClass: 'help-block',
				 rules: { 
					name: { 
		    			required: true, 
		    			maxlength:50,
		    			remote: "rolesAction!checkName.action?orgName=${authorities.name}&math="+Math.random()
					},
					displayName:
					{
						required: true, 
