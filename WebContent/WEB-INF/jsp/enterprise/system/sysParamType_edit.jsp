	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${ctx}/system/sysParamTypeAction!retrieveAllSysParamTypes.action">系统参数类型</a>
				</li>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="#" method="post" id="sysParamTypeForm"  class="form-horizontal" role="form">
						<input type="hidden" name="sysParamType.id" value="${sysParamType.id}"/>
						<input type="hidden" name="sysParamType.token" value="${sysParamType.token}"/>
						<div class="form-group">
							<label class="col-xs-12 col-sm-1 control-label no-padding-right" for="form-field-1">类型名称</label>
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="sysParamType.typeName" value="${sysParamType.typeName}" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="sysParamType.sort" value="${sysParamType.sort}" />
								</div>
							</div>
						</div>
						<div class="form-group">
		...
		$(document).ready(function(){
			...
			$("#sysParamTypeForm").validate({
				...
				submitHandler:function(form){
					 ajaxUpdate(form,'sysParamTypeAction!editSysParamType.action');
			     }
			});
		});
	</script>
