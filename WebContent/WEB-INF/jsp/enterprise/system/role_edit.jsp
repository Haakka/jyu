		...
		<div class="page-content">
			<div>
				<h3 class="row-fluid header smaller  blue" style="line-height: 39px;">
					<span class="span7">编辑角色 </span><!-- /span -->
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form action="rolesAction!updateRose.action" method="post" id="roseForm"  class="form-horizontal" role="form">
						<s:token></s:token>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" id="roseName" name="name" value="${roles.name}" class="col-xs-10 col-sm-5"/>
								</div>
							</div>
						</div>
						<div class="form-group">
