	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="evenAction!retrieveAllEvens.action">客户管理</a>
				</li>
		...
		<div class="page-content">
			<div>
				<h3 class="row-fluid header smaller  blue" style="line-height: 39px;">
					<span class="span7">交往记录列表</span><!-- /span -->

					<span class="span5 pull-right">
						<label class="inline">
							<a class="btn btn-success btn-sm" href="evenAction!newPage.action">
								<i class="icon-plus"></i>
								添加
							</a>
						</label>
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-search" id="searchForm" name="searchForm" method="post" action="${ctx }/evenAction!retrieveAllEvens.action">
						<div class="row">
					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="table-responsive">
											...
											<tr>
												...
												<td>
													<div class="action-buttons">
														 <a class="blue" href="evenAction!viewPage.action?id=${bean.id}&token=${bean.token}" data-rel="tooltip" title="查看">
															 <i class="icon-eye-open bigger-130"></i>
														</a> 
														<a class="green" title="编辑" data-rel="tooltip" href="evenAction!retrieveEvenById.action?id=${bean.id}&token=${bean.token}">
															<i class="icon-pencil bigger-130"></i>
														</a>
														<a class="red"  title="删除" href="#" data-rel="tooltip" onclick="ajaxUpdateDel(${bean.id},this,'${ctx}/ajaxEvenAction!delEven.action');">
								...
								<div class="row">
									<s:form action="evenAction!retrieveAllEvens.action" 
