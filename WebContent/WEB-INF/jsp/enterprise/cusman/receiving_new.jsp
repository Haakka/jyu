					...
					<form action="#" method="post" id="receivingForm"  class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="receiving.money" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="input-group">
									<input class="form-control date-picker" name="receiving.payTime" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" style="width: 210px;"/>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<textarea name="receiving.remark" style="width: 385px;height: 100px;" placeholder="最多输入500个字符"></textarea>
								</div>
							</div>
						</div>
		...
		$(document).ready(function(){
			...
			$("#receivingForm").validate({
				...
				submitHandler:function(form){
					 ajaxAdd(form,'receivingAction!newReceiving.action');
			    }
			});
