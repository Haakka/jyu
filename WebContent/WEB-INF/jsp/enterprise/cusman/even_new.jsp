					...
					<form action="#" method="post" id="evenForm"  class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="even.subject" id="even.subject"/>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<select name="contactorId"  id="form-field-select-2" style="width: 250px" disabled="disabled">
										<option value=""></option>
									</select>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="even.venue" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								...
								<input type="hidden" id="startDate" name ="even.startDate" value="" /><br/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								...
								<input type="hidden" id="endDate" name ="even.endDate" value="" /><br/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<textarea name="even.description" style="width: 385px;height: 100px;" placeholder="最多输入500个字符"></textarea>
								</div>
							</div>
						</div>
		...
		$(document).ready(function(){
			...
			$("#evenForm").validate({
				...
				submitHandler:function(form){
					 ajaxAdd(form,'evenAction!newEven.action');
			    }
			});
