					...
					<form action="#" method="post" id="departmentForm"  class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="department.code" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<input type="text" class="col-xs-10 col-sm-5" name="department.name" />
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<select name="managerId" data-placeholder="请选择..." class="width-80 chosen-select" id="form-field-select-1" style="width: 250px">
										<option value=""></option>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-10">
								<div class="clearfix">
									<textarea name="department.remark" style="width: 385px;height: 100px;" placeholder="最多输入500个字符"></textarea>
								</div>
							</div>
						</div>
		...
		$(document).ready(function(){
			...
			$("#departmentForm").validate({
				...
				submitHandler:function(form){
					ajaxAdd(form,'departmentAction!newDepartment.action');
			    }
